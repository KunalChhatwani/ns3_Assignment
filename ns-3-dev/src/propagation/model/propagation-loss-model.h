 ...
 *
 */
class LogShadowingPropagationLossModel : public PropagationLossModel
{
  public:
    /**
     * \brief Get the type ID.
     ...
     */
    static TypeId GetTypeId();
    LogShadowingPropagationLossModel();

    // Delete copy constructor and assignment operator to avoid misuse
    LogShadowingPropagationLossModel(const LogShadowingPropagationLossModel&) = delete;
    LogShadowingPropagationLossModel& operator=(const LogShadowingPropagationLossModel&) = delete;
